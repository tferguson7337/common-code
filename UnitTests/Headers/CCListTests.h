...
namespace CC
{
    ...
    public:
        ...
        [[nodiscard]] static UTR ElementCopyCtor()
        {
            ...
            SUTL_TEST_ASSERT(!list.m_pHead->pPrev);
    ...
    public:
        ...
        [[nodiscard]] static UTR AppendMethodElementCopy()
        {
            ...
            SUTL_TEST_ASSERT(!dst.m_pHead->pPrev);
            ...
            SUTL_TEST_ASSERT(dst.m_pHead->pNext->pPrev == dst.m_pHead);
            ...
            SUTL_TEST_ASSERT(dst.m_pHead->pNext->pNext->pPrev == dst.m_pHead->pNext);
        ...
        [[nodiscard]] static UTR PrependElementCopy()
        {
            ...
            SUTL_TEST_ASSERT(!dst.m_pTail->pPrev);
            ...
            SUTL_TEST_ASSERT(!dst.m_pTail->pNext);
            SUTL_TEST_ASSERT(!!dst.m_pTail->pPrev);
            SUTL_TEST_ASSERT(dst.m_pTail->pPrev->data == testData[1]);
            SUTL_TEST_ASSERT(dst.m_pTail->pPrev == dst.m_pHead);
            SUTL_TEST_ASSERT(!dst.m_pTail->pPrev->pPrev);
            if constexpr (bIsHelper)
            {
                // Verify element copy (not move).
                SUTL_TEST_ASSERT(dst.m_pTail->pPrev->data.m_bCopied);
                SUTL_TEST_ASSERT(!dst.m_pTail->pPrev->data.m_bMoved);
            }
            ...
            SUTL_TEST_ASSERT(!dst.m_pTail->pNext);
            SUTL_TEST_ASSERT(!!dst.m_pTail->pPrev);
            SUTL_TEST_ASSERT(dst.m_pTail->pPrev->pPrev == dst.m_pHead);
            SUTL_TEST_ASSERT(!!dst.m_pTail->pPrev->pPrev);
            SUTL_TEST_ASSERT(dst.m_pTail->pPrev->pPrev->data == testData[2]);
            SUTL_TEST_ASSERT(dst.m_pTail->pPrev == dst.m_pHead->pNext);
            SUTL_TEST_ASSERT(!dst.m_pTail->pPrev->pPrev->pPrev);
            if constexpr (bIsHelper)
            {
                // Verify element copy (not move).
                SUTL_TEST_ASSERT(dst.m_pTail->pPrev->pPrev->data.m_bCopied);
                SUTL_TEST_ASSERT(!dst.m_pTail->pPrev->pPrev->data.m_bMoved);
            }
        ...
        [[nodiscard]] static UTR InsertAtMidElementCopy()
        {
            ...
            SUTL_TEST_ASSERT(pTail->pPrev == pMid);
            // Ensure tail is linked properly with the middle node.
            SUTL_TEST_ASSERT(pMid->pPrev == pHead);
