...
class StringUtilTests
{
    ...
    using OT = StringUtil::OperationType;
    using OT_T = std::underlying_type_t<OT>;

    using EER = StringUtil::EarlyExitResult;
    using EER_T = std::underlying_type_t<EER>;

    using RT = StringUtil::ReturnType;
    using RT_T = std::underlying_type_t<RT>;

    using BT = StringUtil::NumberConversion::Base;
    ...
    static const C* GetStringPointer(const void* obj)
    {
        ...
        if constexpr ( RT == StringUtil::ReturnType::SmartCString )
        {
            return reinterpret_cast<const std::unique_ptr<C[ ]>*>(obj)->get( );
        }
        else if constexpr ( RT == StringUtil::ReturnType::StringObj )
        {
...
public:
    static UTR InvalidOperationType( )
    {
        ...
        SUTL_TEST_ASSERT(!StringUtil::IsValidOperationType<invalidOT1>( ));
        SUTL_TEST_ASSERT(!StringUtil::IsValidOperationType<invalidOT2>( ));
    ...
    {
        SUTL_TEST_ASSERT(StringUtil::IsValidOperationType<OT::Comparison>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidOperationType<OT::Copy>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidOperationType<OT::UTFConversion>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidOperationType<OT::NumberConversion>( ));
    ...
    static UTR InvalidEarlyExitResult( )
    {
        ...
        SUTL_TEST_ASSERT(!StringUtil::IsValidEarlyExitResult<invalidEER1>( ));
        SUTL_TEST_ASSERT(!StringUtil::IsValidEarlyExitResult<invalidEER2>( ));
    ...
    {
        SUTL_TEST_ASSERT(StringUtil::IsValidEarlyExitResult<EER::NoExit>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidEarlyExitResult<EER::True>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidEarlyExitResult<EER::False>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidEarlyExitResult<EER::EmptyString>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidEarlyExitResult<EER::ZeroedBuffer>( ));
    ...
    static UTR InvalidReturnType( )
    {
        ...
        SUTL_TEST_ASSERT(!StringUtil::IsValidReturnType<invalidRT1>( ));
        SUTL_TEST_ASSERT(!StringUtil::IsValidReturnType<invalidRT2>( ));
    ...
    {
        SUTL_TEST_ASSERT(StringUtil::IsValidReturnType<RT::SmartCString>( ));
        SUTL_TEST_ASSERT(StringUtil::IsValidReturnType<RT::StringObj>( ));
    ...
    static UTR InvalidBaseType( )
    {
        ...
        SUTL_TEST_ASSERT(!StringUtil::NumberConversion::IsValidBaseType<invalidBT1>( ));
        SUTL_TEST_ASSERT(!StringUtil::NumberConversion::IsValidBaseType<invalidBT2>( ));
    ...
    {
        SUTL_TEST_ASSERT(StringUtil::NumberConversion::IsValidBaseType<BT::Binary>( ));
        SUTL_TEST_ASSERT(StringUtil::NumberConversion::IsValidBaseType<BT::Octal>( ));
        SUTL_TEST_ASSERT(StringUtil::NumberConversion::IsValidBaseType<BT::Decimal>( ));
        SUTL_TEST_ASSERT(StringUtil::NumberConversion::IsValidBaseType<BT::Hexadecimal>( ));
...
public:
    ...
    {
        const auto str = StringUtil::BuildString<RT, C>(0);
    ...
    template <StringUtil::ReturnType RT, typename C>
    static UTR OneLength( )
    {
        const auto str = StringUtil::BuildString<RT, C>(1);
        const C* p = GetStringPointer<RT, C>(&str);
    ...
    static UTR ManyLength( )
    {
        ...
        const auto str = StringUtil::BuildString<RT, C>(len);
        const C* p = GetStringPointer<RT, C>(&str);
...
public:
    ...
    {
        SUTL_TEST_ASSERT(StringUtil::GetLength<C>(nullptr) == 0);
        SUTL_TEST_SUCCESS( );
    }
    ...
    static UTR ZeroLength( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::GetLength<C>(str.c_str( )) == str.length( ));
        SUTL_TEST_SUCCESS( );
    }
...
public:
    ...
    static UTR SameLengthDifferentStrs( )
    {
        ...
        const EER eer = StringUtil::CheckForComparisonEarlyExit<C>(str1.c_str( ), str1.length( ), str2.c_str( ), str2.length( ));
    ...
    static UTR OneNullptr( )
    {
        ...
        const EER eer = StringUtil::CheckForComparisonEarlyExit<C>(nullptr, str1.length( ), str2.c_str( ), str2.length( ));
    ...
    static UTR BothNullptr( )
    {
        ...
        const EER eer = StringUtil::CheckForComparisonEarlyExit<C>(nullptr, str1.length( ), nullptr, str2.length( ));
    ...
    static UTR SamePtr( )
    {
        ...
        const EER eer = StringUtil::CheckForComparisonEarlyExit<C>(str.c_str( ), str.length( ), str.c_str( ), str.length( ));
...
public:
    ...
    static UTR LengthMismatch( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare(str1.c_str( ), str1.length( ), str2.c_str( ), str2.length( ), false) == false);
        SUTL_TEST_ASSERT(StringUtil::Compare(str1.c_str( ), str1.length( ), str2.c_str( ), str2.length( ), true) == false);
    ...
    static UTR BothZeroLength( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare(str1.c_str( ), 0, str2.c_str( ), 0, false) == true);
        SUTL_TEST_ASSERT(StringUtil::Compare(str1.c_str( ), 0, str2.c_str( ), 0, true) == true);
    ...
    static UTR OneNullptr( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare<C>(nullptr, str1.length( ), str2.c_str( ), str2.length( ), false) == false);
        SUTL_TEST_ASSERT(StringUtil::Compare<C>(nullptr, str1.length( ), str2.c_str( ), str2.length( ), true) == false);
        SUTL_TEST_ASSERT(StringUtil::Compare<C>(str1.c_str( ), str1.length( ), nullptr, str2.length( ), false) == false);
        SUTL_TEST_ASSERT(StringUtil::Compare<C>(str1.c_str( ), str1.length( ), nullptr, str2.length( ), true) == false);
    ...
    static UTR BothNullptr( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare<C>(nullptr, str1.length( ), nullptr, str2.length( ), false) == true);
        SUTL_TEST_ASSERT(StringUtil::Compare<C>(nullptr, str1.length( ), nullptr, str2.length( ), true) == true);
    ...
    static UTR SamePtr( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare(str.c_str( ), str.length( ), str.c_str( ), str.length( ), false) == true);
        SUTL_TEST_ASSERT(StringUtil::Compare(str.c_str( ), str.length( ), str.c_str( ), str.length( ), true) == true);
    ...
    static UTR CaseInsensitiveDifferentCasing( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare(str1.c_str( ), str1.length( ), str2.c_str( ), str2.length( ), false) == true);
    ...
    static UTR CaseSensitiveMatch( )
    {
        ...
        SUTL_TEST_ASSERT(StringUtil::Compare(str1.c_str( ), str1.length( ), str2.c_str( ), str2.length( ), true) == true);
...
public:
    ...
    static UTR Nullptr( )
    {
        ...
        const EER eer = StringUtil::CheckForCopyEarlyExit<RT, C>(nullptr, str.length( ));
    ...
    static UTR ZeroLength( )
    {
        ...
        const EER eer = StringUtil::CheckForCopyEarlyExit<RT, C>(str.c_str( ), str.length( ));
...
public:
    ...
    {
        const TestStr<C>& str = GetManyLengthStr<C>( );
        const auto copy = StringUtil::Copy<RT, C>(nullptr, str.length( ));
    ...
    {
        const TestStr<C>& str = GetZeroLengthStr<C>( );
        const auto copy = StringUtil::Copy<RT, C>(str.c_str( ), str.length( ));
        const C* ptr = GetStringPointer<RT, C>(&copy);
...
public:
    ...
    static UTR Nullptr( )
    {
        ...
        const EER eer = StringUtil::CheckForUTFConversionEarlyExit<RT, C>(nullptr, str.length( ));
    ...
    static UTR ZeroLength( )
    {
        ...
        const EER eer = StringUtil::CheckForUTFConversionEarlyExit<RT, C>(str.c_str( ), str.length( ));
...
{
public:
    template <StringUtil::ReturnType RT, typename CDst, typename CSrc>
    static UTR Nullptr( )
    {
        const TestStr<CSrc>& str = GetManyLengthStr<CSrc>( );
        const auto conv = StringUtil::UTFConversion<RT, CDst, CSrc>(nullptr, str.length( ));
    ...
    static UTR ZeroLength( )
    {
        ...
        const auto conv = StringUtil::UTFConversion<RT, CDst, CSrc>(str.c_str( ), str.length( ));
...
inline std::list<StringUtilTests::UTFunc> StringUtilTests::GetTests( )
{
